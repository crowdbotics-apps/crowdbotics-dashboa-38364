...
## Project Structure
    ...
    ├── crowdbotics_dashboa_38364  # Django project configurations
...
1. Clone this repo and `cd crowdbotics_dashboa_38364`
...
2. Clone this repo and `cd crowdbotics_dashboa_38364`
